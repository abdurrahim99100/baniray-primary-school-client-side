...
const SignIn = () => {
    ...
    return (
        <>
            <Helmet><title>BPS | SignIn</title></Helmet>
                        ...
                        <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
                            ...
                            <div>
                                <p className="mb-0 mt-2 pt-1 text-sm font-semibold">
                                    ...
                                    <Link to="/sign-up" className="text-green-500 transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700"> Register</Link>
                                </p>
