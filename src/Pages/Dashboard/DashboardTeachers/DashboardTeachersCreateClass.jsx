...
const DashboardTeachersCreateClass = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if (res.data.success) {
            ...
            const response = await axiosSecure.post('/classes', classItem);
            if (response.data.insertedId) {
                reset();
                navigate('/dashboard/teachers-class-management')
                notify('Class Created Successfully', user?.photoURL, user?.displayName);
                Swal.fire({
                    position: "center",
                    icon: "success",
    ...
    return (
        <div className="container mx-auto p-8">
            <div className="text-center py-16 mb-12">
                <h2 className="text-5xl font-bold text-gray-900 mb-4">Create a New Class</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-white p-8 shadow-lg rounded-lg">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="mb-4">
                        ...
                        />
                        {errors.teacher && <span className="text-red-600">{errors?.teacher.message}</span>}
                    </div>
                    <div className="mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            {...register("learningObjectives", { required: 'Learning object is required' })}
                            className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            rows="4"
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            id="whatLearned"
                            {...register("whatLearned", { required: 'What learned is required' })}
                            className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            rows="4"
                            placeholder="Separate by commas"
                        ></textarea>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="mb-6">
                        ...
                        <textarea
                            id="materialsNeeded"
                            {...register("materialsNeeded", { required: "Materials is required" })}
                            className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            rows="4"
                            placeholder="Separate by commas"
                        ></textarea>
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            {...register("additionalResources", { required: 'Additional resource is required' })}
                            className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            rows="4"
                            placeholder="Separate by commas"
                        ></textarea>
...
export default DashboardTeachersCreateClass;
